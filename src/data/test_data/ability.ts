export default {
  ...
  effect_entries: [
    {
      effect:
        "Während strong sunlight ist die speed eines Pokémon mit dieser Fähigkeit doppelt so hoch wie normal.\n\nDieser Bonus zählt nicht als stat modifier.",
      language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" },
      short_effect: "Verdoppelt die speed während starkem Sonnenlicht.",
    },
    {
      effect:
  ...
  flavor_text_entries: [
    ...
    {
      flavor_text: "Augmente la Vitesse du Pokémon s’il y a du soleil.",
      language: { name: "fr", url: "https://pokeapi.co/api/v2/language/5/" },
      version_group: {
        name: "sun-moon",
        url: "https://pokeapi.co/api/v2/version-group/17/",
    ...
    {
      flavor_text: "Erhöht bei Sonnenschein die Initiative.",
      language: { name: "de", url: "https://pokeapi.co/api/v2/language/6/" },
      version_group: {
        name: "sun-moon",
        url: "https://pokeapi.co/api/v2/version-group/17/",
    ...
    {
      flavor_text: "Sube la Velocidad cuando hace sol.",
      language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" },
      version_group: {
        name: "sun-moon",
        url: "https://pokeapi.co/api/v2/version-group/17/",
    ...
    {
      flavor_text: "Se la luce del sole è intensa, la Velocità aumenta.",
      language: { name: "it", url: "https://pokeapi.co/api/v2/language/8/" },
      version_group: {
        name: "sun-moon",
        url: "https://pokeapi.co/api/v2/version-group/17/",
    ...
    {
      flavor_text: "Boosts the Pokémon’s Speed stat in sunshine.",
      language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" },
      version_group: {
        name: "sun-moon",
        url: "https://pokeapi.co/api/v2/version-group/17/",
    ...
    {
      flavor_text: "Boosts the Pokémon’s Speed stat in harsh sunlight.",
      language: { name: "en", url: "https://pokeapi.co/api/v2/language/9/" },
      version_group: {
        name: "ultra-sun-ultra-moon",
        url: "https://pokeapi.co/api/v2/version-group/18/",
    ...
    {
      flavor_text: "Sube su Velocidad cuando hace sol.",
      language: { name: "es", url: "https://pokeapi.co/api/v2/language/7/" },
      version_group: {
        name: "sword-shield",
        url: "https://pokeapi.co/api/v2/version-group/20/",
